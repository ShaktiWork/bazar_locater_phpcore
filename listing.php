  ...
  <select class="form-control select_bar" id="category" onchange="loadSubCategory();" style="width:100%;">
   ...
   <select class="form-control select_bar"  id= "subcategory"style="width:100%;">
    ...
    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 categary">
            ...
            <div class="contact_no"><span class="glyphicon glyphicon-phone"></span>+91- 9891869911</div>
            <div class="contact_no"><span class="glyphicon glyphicon-envelope"></span>&nbsp;wecartonline@gamial.com</div>
            ...
            <div class="contact_no">Wecart-Online Shopping Destination India, Delhi, India</div>
            </div>
    ...
    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 categary">
            ...
            <div class="col-lg-4 col-md-3 col-sm-3col-xs-12"> 
			<div class="sent_enqiury">Write review</div>
            <div class=""><img src="" class="img-responsive" /></div>            
            </div>
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12"> 
            ...
            <div class="contact_no">Wecart-Online Shopping Destination India, Delhi, India</div>
				...
				<div class="box_shodow ">
					<div class="img_box">
						<img src="img/category/DRUG_0_0_0_0_0_0_0_0.jpg" class="img-responsive" alt="clothes">
                                <div class="overlay"></div>
                                </div>
                                	</div>
